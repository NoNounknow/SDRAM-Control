...
xst -ifn xst.scr
move PLL_base50mhz_25mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_base50mhz_25mhz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_base50mhz_25mhz_exdes.ucf PLL_base50mhz_25mhz_exdes

echo 'Running map'
map -timing -pr b PLL_base50mhz_25mhz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PLL_base50mhz_25mhz_exdes -w routed.ncd routed.v
cd ..
